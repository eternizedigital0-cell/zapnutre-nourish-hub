...
const navItems = [
  { path: "/nutricionista/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { path: "/nutricionista/pacientes", label: "Pacientes", icon: Users },
  { path: "/nutricionista/relatorios", label: "Relatórios", icon: BarChart3 },
  { path: "/nutricionista/configuracoes", label: "Configurações", icon: Settings },
];
